...
<div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-3">
  ...
  <form method="GET" action="<?= $__panelPrefix ?>/reportes" class="d-flex flex-column flex-sm-row gap-2 align-items-sm-end">
    <div>
    ...
    <div class="d-flex gap-2">
      ...
      <a class="btn btn-outline-secondary" href="<?= $__panelPrefix ?>/reportes">
...
<script>
  (async () => {
    ...
    const base = <?= json_encode($__panelPrefix, JSON_UNESCAPED_SLASHES) ?>;
    const res = await fetch(base + '/reportes/data?' + params.toString(), {
      headers: {

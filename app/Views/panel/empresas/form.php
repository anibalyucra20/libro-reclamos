...
<div class="d-flex align-items-center justify-content-between mb-3">
  ...
  <a class="btn btn-outline-secondary" href="/empresas"><i class="bi bi-arrow-left me-1"></i> Volver</a>
</div>
...
<div class="card border-0 shadow-sm">
  <div class="card-body">
    <form method="POST" action="<?= $mode==='new' ? '/empresas' : '/empresas/'.$id ?>" class="row g-3">
      ...
      <div class="col-12 d-flex gap-2">
        ...
        <a class="btn btn-outline-secondary" href="/empresas">Cancelar</a>
      </div>
    </form>
  </div>
</div>
